...
if (!empty($course)) {
    ...
    if ($overviewfilesoptions) {
        file_prepare_standard_filemanager(
            $course, 'overviewfiles', $overviewfilesoptions, $coursecontext, 'course', 'overviewfiles', 0);
    }
...
if ($editform->is_cancelled()) {
    ...
    if (empty($course->id)) {
        ...
        if (!empty($CFG->creatornewroleid) and
            !is_viewing($context, null, 'moodle/role:assign') and !is_enrolled($context, null, 'moodle/role:assign')) {
