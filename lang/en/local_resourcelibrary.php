...
$string['addcataloguepage'] = 'Add catalogue page';
...
$string['aria:entityimage'] = 'Entity image';
...
$string['card'] = 'Card';
$string['cataloguepage'] = 'Catalogue page';
$string['cataloguepagecreated'] = 'Catalogue page created successfully';
$string['cataloguepages'] = 'Catalogue pages';
$string['cataloguepageupdated'] = 'Catalogue page updated successfully';
$string['categories'] = 'Course categories';
$string['categories_help'] = 'Select the course categories to include in this catalogue page';
...
$string['customfields_help'] = 'Select the custom fields to filter by in this catalogue page';
$string['editcataloguepage'] = 'Edit catalogue page';
...
$string['invalidcataloguepage'] = 'Invalid catalogue page';
...
$string['resourcelibrary:managecatalogues'] = 'Can manage catalogue pages';
